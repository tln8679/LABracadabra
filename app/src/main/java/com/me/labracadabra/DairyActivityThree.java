 ...
 */
public class DairyActivityThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dairy_three);
    ...
    public void initReader(){
        final String initMessage = "Which of the following is not found in the dairy aisle";
        ...
        switch (v.getId()) {
            ...
            case R.id.add:
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(DairyActivityThree.this, DairyActivityFour.class);
    ...
    public void incorrectMessage(){
        Toast.makeText(DairyActivityThree.this,
